...
class Titan: Soldier {
    ...
    required init(_ location: float2) {
        super.init(location, Health(125, Shield(Float(90), Float(0.5), Float(0))), float4(1), "Titan")
        let firer = Firer(1.0, Impact(30, 14.m), Casing(float2(0.7.m, 0.175.m), float4(1, 0.25, 1, 1), "player"))
